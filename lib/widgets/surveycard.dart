...
final String region;
final String psname;
  const Surveycard({super.key, required this.name, required this.age, required this.voterid, required this.pscode, required this.sex, required this.image, required this.constituency, required this.region, required this.psname, });
                ...
                Row(
                  ...
                  children: [
                    Padding(
                        ...
                        child: CachedNetworkImage( imageUrl: image, height: 180,width: 180,fit: BoxFit.cover,)
                    ),
